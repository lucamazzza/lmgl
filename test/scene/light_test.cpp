...
TEST_F(LightTest, DefaultColor) { EXPECT_EQ(dir_light->get_color(), glm::vec3(1.0f, 1.0f, 1.0f)); }
...
TEST_F(LightTest, DefaultIntensity) { EXPECT_FLOAT_EQ(dir_light->get_intensity(), 1.0f); }
...
TEST_F(LightTest, DefaultDirection) { EXPECT_EQ(dir_light->get_direction(), glm::vec3(0.0f, -1.0f, 0.0f)); }
...
TEST_F(LightTest, DefaultPosition) { EXPECT_EQ(point_light->get_position(), glm::vec3(0.0f, 0.0f, 0.0f)); }
...
TEST_F(LightTest, DefaultRange) { EXPECT_FLOAT_EQ(point_light->get_range(), 10.0f); }
...
TEST_F(LightTest, DefaultShadowCasting) { EXPECT_FALSE(dir_light->casts_shadows()); }
...
TEST_F(LightTest, SunLight) {
    auto sun = Light::create_directional(glm::vec3(0.3f, -1.0f, -0.2f), glm::vec3(1.0f, 0.95f, 0.9f));
...
TEST_F(LightTest, LampLight) {
    auto lamp = Light::create_point(glm::vec3(0.0f, 2.0f, 0.0f), 5.0f, glm::vec3(1.0f, 0.8f, 0.6f));
...
TEST_F(LightTest, FlashlightLight) {
    auto flashlight = Light::create_spot(glm::vec3(0.0f, 1.0f, 0.0f), glm::vec3(0.0f, 0.0f, -1.0f), 25.0f);
